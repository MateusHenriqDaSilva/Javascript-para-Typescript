_a34‍.x([["CalcularTaxa",()=>CalcularTaxa],["TotalProdutoComTaxa",()=>TotalProdutoComTaxa],["MostrarDetalhes",()=>MostrarDetalhes],["AplicarDesconto",()=>AplicarDesconto]]);function CalcularTaxa(precos) {
    return Number(precos) * 1.2
}

       function TotalProdutoComTaxa(...precos) {
    ...
    console.log(`Nome: ${produto.nome}, Preco da Taxa: ${taxarPreco}`)
       ...
       function AplicarDesconto(produto, desconto = 5) {
